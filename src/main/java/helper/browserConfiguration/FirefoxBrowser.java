...
public class FirefoxBrowser {
    ...
    public WebDriver getFirefoxDriver(FirefoxOptions cap) {
        ...
        if (System.getProperty("os.name").contains("Mac")) {
            System.setProperty("webdriver.gecko.driver", ResourceHelper.getResourcePath("src/main/java/com/resources/drivers/geckodriver"));
            return new FirefoxDriver(cap);
        } else if (System.getProperty("os.name").contains("Window")) {
            System.setProperty("webdriver.gecko.driver", ResourceHelper.getResourcePath("src/main/java/com/resources/drivers/geckodriver.exe"));
            return new FirefoxDriver(cap);
